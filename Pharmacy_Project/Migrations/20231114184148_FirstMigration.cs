        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incomings_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                name: "MedicinesForDiseases",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MidicineId = table.Column<int>(type: "int", nullable: false),
                    DiseaseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicinesForDiseases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicinesForDiseases_Diseases_DiseaseId",
                        column: x => x.DiseaseId,
                        principalTable: "Diseases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicinesForDiseases_Medicines_MidicineId",
                        column: x => x.MidicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Outgoings_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicinesForDiseases_DiseaseId",
                table: "MedicinesForDiseases",
                column: "DiseaseId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicinesForDiseases_MidicineId",
                table: "MedicinesForDiseases",
                column: "MidicineId");

            migrationBuilder.CreateIndex(
                name: "IX_Outgoings_MedicineId",
                table: "Outgoings",
                column: "MedicineId");
        }
